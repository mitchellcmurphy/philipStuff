...
g++ --std=c++14 -O0 -Wall -Werror -pedantic -o bst_wordcount_O0 BST.cpp wordcount_bst.cpp

echo "build bst level 1 optimized"
g++ --std=c++14 -O1 -Wall -Werror -pedantic -o bst_wordcount_O1 BST.cpp wordcount_bst.cpp

echo "build bst level 2 optimized"
g++ --std=c++14 -O2 -Wall -Werror -pedantic -o bst_wordcount_O2 BST.cpp wordcount_bst.cpp

echo "build bst level 3 optimized"
g++ --std=c++14 -O3 -Wall -Werror -pedantic -o bst_wordcount_O3 BST.cpp wordcount_bst.cpp
