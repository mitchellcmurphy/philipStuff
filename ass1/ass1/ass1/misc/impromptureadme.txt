...
To run a light version of the program, which will only process 3 text files and NOT provide any performance time data. Run the following command
./RUNLite.sh

To run the code with your own input file, please run the following command\
./RUNMy.sh < *your input file* > *your output file